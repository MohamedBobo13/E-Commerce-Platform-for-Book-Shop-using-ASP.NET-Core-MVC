    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int orderId)
        {
            OrderVM = new()
            {
                ...
                OrderDetail = _unitOfWork.OrderDetail.GetAll(u => u.OrderHeaderId == orderId, includeProperty: "Product")
            };
            return View(OrderVM);
        }
        ...
        public IActionResult Details_Pay_Now()
        {
            OrderVM.OrderHeader = _unitOfWork.OrderHeader
                .Get(u => u.Id == OrderVM.OrderHeader.Id, includeProperty: "ApplicationUser");
